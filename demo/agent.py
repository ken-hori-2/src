...
class Agent():
    ...
    def policy_advance(self, state, TRIGAR): # , TRIGAR_REVERSE):
        ...
        # try:
        # y_n, action = self.model_advance(state)
    ...
    def model_advance(self, state):
        ...
        # else:
        #     print("STRESS MAX TRIGAR")
        #     for dir in next_diretion:
        #         print("\ndir:{}".format(dir))
        #         y_n, action = self.env.expected_move_return(state, dir, self.TRIGAR_advance)
    ...
    def model_bp(self, state):
        ...
        # if not self.TRIGAR_bp:
        #     for dir in next_diretion:

        #         print("dir:{}".format(dir))
        #         y_n, action = self.env.expected_move(state, dir, self.TRIGAR_bp)
        ...
        if self.TRIGAR_REVERSE_bp:
            ...
            for dir in next_diretion:
                print("\ndir:{}".format(dir))
                # y_n, action = self.env.expected_move_return_reverse(state, dir, self.trigar)
